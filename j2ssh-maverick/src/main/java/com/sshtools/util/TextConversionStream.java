...
public class TextConversionStream extends FilterOutputStream {
	...
	public TextConversionStream(int inputStyle, int outputStyle,
			OutputStream out) {
	...
	public static void main(String[] args) {
		...
		try {
			TextConversionStream t = new TextConversionStream(TEXT_CRLF,
					TEXT_CR, new FileOutputStream("C:\\TEXT.txt"));
			...
			System.out.println("RECIEVED IOException IN Ssh1Protocol.close:"
					+ e.getMessage());
