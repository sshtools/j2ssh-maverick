...
/**
 *
 * <p>Compression interface which can be implemented to provide the SSH
 * Transport Protocol with compression.</p>
...
public interface SshCompression {
   ...
   * @param type  the mode of the compression, should be either INFLATER or DEFLATER
