 ...
 * terminal modes that it knows of. This is typically used in situations where
 * advance terminal configuration is required but it can also be used to perform
 * simple configuration such as turning off character echo.
 * </p>
 * 
 * <p>
 * <em>NOTE: the server may ignore some of the modes set if it does not
 * support them.</em>
 * </p>
 * 
 * <blockquote>
