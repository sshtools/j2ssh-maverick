 ...
 * methods.</p>
 * <p>The objects returned could either be {@link com.maverick.sftp.SftpFile}
 * or <em>java.io.File</em> depending upon the commit state and whether
 * syncronization is required. Any code using the values returned should
 * be able to handle both types of file object.</p>
 *
...
public class DirectoryOperation {
  ...
  public long getTransferSize() throws SftpStatusException, SshException {
    ...
    SftpFile sftpfile;
    File file;
    for (Enumeration e = newFiles.elements();
         e.hasMoreElements(); ) {
      obj = e.nextElement();
    ...
    for (Enumeration e = updatedFiles.elements();
         e.hasMoreElements(); ) {
      obj = e.nextElement();
