 ...
 * </pre></blockquote>
 * <p>matchFilesWithPattern performs a Glob regular expression pattern match on the SftpFiles passed to it, using fileNameRegExp, then returns the ones that match.</p>
 */
public class GlobRegExpMatching implements RegularExpressionMatching {
    ...
    public String[] matchFileNamesWithPattern(File[] files, String fileNameRegExp) throws SshException {
        ...
        Vector matchedNames = new Vector();
